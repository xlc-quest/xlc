const IS_CONNECTION_SERVER = true;

export const CONNECTION_SERVER_ID = '@connections';
export const CONNECTION_SERVER_URLS = ['https://xlc.quest', 'http://174.127.170.242:3000'];
...
export const SERVER_URL = process.env.PORT ? 'https://xlc.quest' : `http://174.127.170.242:${SERVER_PORT}`;
